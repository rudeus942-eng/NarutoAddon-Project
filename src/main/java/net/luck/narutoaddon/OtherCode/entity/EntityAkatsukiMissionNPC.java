...
public class EntityAkatsukiMissionNPC extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 255;

   public EntityAkatsukiMissionNPC(ElementsInfTsukAddon instance) {
      super(instance, 255);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "akatsukimissionnpc"), 255).name("akatsukimissionnpc").tracker(64, 3, true).egg(-1, -1).build());
   }
