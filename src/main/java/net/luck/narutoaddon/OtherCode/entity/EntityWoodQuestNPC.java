...
public class EntityWoodQuestNPC extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 249;

   public EntityWoodQuestNPC(ElementsInfTsukAddon instance) {
      super(instance, 249);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "woodquestnpc"), 249).name("woodquestnpc").tracker(64, 3, true).egg(-1, -1).build());
   }
