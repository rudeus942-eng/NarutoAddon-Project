...
public class EntityTerritoryDefender extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 250;

   public EntityTerritoryDefender(ElementsInfTsukAddon instance) {
      super(instance, 250);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "territorydefender"), 250).name("territorydefender").tracker(64, 3, true).egg(-1, -1).build());
   }
