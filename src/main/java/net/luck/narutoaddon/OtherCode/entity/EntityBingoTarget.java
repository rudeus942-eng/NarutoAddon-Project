...
public class EntityBingoTarget extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 251;

   public EntityBingoTarget(ElementsInfTsukAddon instance) {
      super(instance, 251);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "bingotarget"), 251).name("bingotarget").tracker(64, 3, true).egg(-1, -1).build());
   }
