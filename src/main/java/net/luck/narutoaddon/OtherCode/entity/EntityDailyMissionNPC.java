...
public class EntityDailyMissionNPC extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 256;

   public EntityDailyMissionNPC(ElementsInfTsukAddon instance) {
      super(instance, 256);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "dailymissionnpc"), 256).name("dailymissionnpc").tracker(64, 3, true).egg(-1, -1).build());
   }
