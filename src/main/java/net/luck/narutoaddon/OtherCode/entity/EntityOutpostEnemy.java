...
public class EntityOutpostEnemy extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 252;

   public EntityOutpostEnemy(ElementsInfTsukAddon instance) {
      super(instance, 252);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "outpostenemy"), 252).name("outpostenemy").tracker(64, 3, true).egg(-1, -1).build());
   }
