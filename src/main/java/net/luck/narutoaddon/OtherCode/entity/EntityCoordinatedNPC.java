...
public class EntityCoordinatedNPC extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 247;

   public EntityCoordinatedNPC(ElementsInfTsukAddon instance) {
      super(instance, 247);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "coordinatednpc"), 247).name("coordinatednpc").tracker(64, 3, true).egg(-1, -1).build());
   }
