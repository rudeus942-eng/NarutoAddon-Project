...
public class EntitySenjuWaterNPC extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 248;

   public EntitySenjuWaterNPC(ElementsInfTsukAddon instance) {
      super(instance, 248);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "senjuwaternpc"), 248).name("senjuwaternpc").tracker(64, 3, true).egg(-1, -1).build());
   }
