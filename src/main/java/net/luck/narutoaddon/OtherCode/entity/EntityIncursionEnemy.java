...
public class EntityIncursionEnemy extends ElementsInfTsukAddon.ModElement {
   public static final int ENTITYID = 254;

   public EntityIncursionEnemy(ElementsInfTsukAddon instance) {
      super(instance, 254);
   }

   public void initElements() {
      this.elements.entities.add((Supplier)() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("inftsukaddon", "incursionenemy"), 254).name("incursionenemy").tracker(64, 3, true).egg(-1, -1).build());
   }
