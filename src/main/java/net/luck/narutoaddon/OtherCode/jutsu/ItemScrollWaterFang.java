...
public class ItemScrollWaterFang extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_water_fang")
   public static final Item block = null;

   public ItemScrollWaterFang(ElementsInfTsukAddon instance) {
      super(instance, 911);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.maxStackSize = 1;
         this.setTranslationKey("scroll_water_fang");
         this.setRegistryName("scroll_water_fang");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§7Teaches: §3Water Fang Bullet");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            try {
               ...
               Object result = enableMethod.invoke((Object)null, player, (ItemJutsu.Base)suitonItem, SuitonPatcher.WATER_FANG_BULLET, true);
               if (result != null) {
                  stack.shrink(1);
                  player.sendMessage(new TextComponentString("§b§l★ Jutsu Learned! §r§3Water Fang Bullet §ahas been added to your Water Release!"));
               ...
               System.err.println("[InfTsuk] ScrollWaterFang: Failed to enable jutsu: " + e.getMessage());
               e.printStackTrace();
