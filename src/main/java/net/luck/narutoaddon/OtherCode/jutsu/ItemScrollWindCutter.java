...
public class ItemScrollWindCutter extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_wind_cutter")
   public static final Item block = null;

   public ItemScrollWindCutter(ElementsInfTsukAddon instance) {
      super(instance, 273);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.maxStackSize = 1;
         this.setTranslationKey("scroll_wind_cutter");
         this.setRegistryName("scroll_wind_cutter");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§7Teaches: §bWind Cutter");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            try {
               ...
               Object result = enableMethod.invoke((Object)null, player, (ItemJutsu.Base)futonItem, FutonPatcher.WIND_CUTTER, true);
               if (result != null) {
                  stack.shrink(1);
                  player.sendMessage(new TextComponentString("§6§l★ Jutsu Learned! §r§bWind Cutter §ahas been added to your Wind Release!"));
               ...
               System.err.println("[InfTsuk] ScrollWindCutter: Failed to enable jutsu: " + e.getMessage());
               e.printStackTrace();
