...
public class ItemScrollPressureDamage extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_pressure_damage")
   public static final Item block = null;

   public ItemScrollPressureDamage(ElementsInfTsukAddon instance) {
      super(instance, 914);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.maxStackSize = 1;
         this.setTranslationKey("scroll_pressure_damage");
         this.setRegistryName("scroll_pressure_damage");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§7Teaches: §bPressure Damage");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            try {
               ...
               Object result = enableMethod.invoke((Object)null, player, (ItemJutsu.Base)futonItem, FutonPatcher.PRESSURE_DAMAGE, true);
               if (result != null) {
                  stack.shrink(1);
                  player.sendMessage(new TextComponentString("§6§l★ Jutsu Learned! §r§bPressure Damage §ahas been added to your Wind Release!"));
               ...
               System.err.println("[InfTsuk] ScrollPressureDamage: Failed to enable jutsu: " + e.getMessage());
               e.printStackTrace();
