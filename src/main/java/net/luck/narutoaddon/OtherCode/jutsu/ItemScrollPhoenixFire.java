...
public class ItemScrollPhoenixFire extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_phoenix_fire")
   public static final Item block = null;

   public ItemScrollPhoenixFire(ElementsInfTsukAddon instance) {
      super(instance, 271);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.maxStackSize = 1;
         this.setTranslationKey("scroll_phoenix_fire");
         this.setRegistryName("scroll_phoenix_fire");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§7Teaches: §cPhoenix Sage Fire");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            try {
               ...
               Object result = enableMethod.invoke((Object)null, player, (ItemJutsu.Base)katonItem, KatonPatcher.PHOENIX_SAGE_FIRE, true);
               if (result != null) {
                  stack.shrink(1);
                  player.sendMessage(new TextComponentString("§6§l★ Jutsu Learned! §r§cPhoenix Sage Fire §ahas been added to your Fire Release!"));
               ...
               System.err.println("[InfTsuk] ScrollPhoenixFire: Failed to enable jutsu: " + e.getMessage());
               e.printStackTrace();
