...
public class ItemScrollBlueAmplifiedPalm extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_blue_amplified_palm")
   public static final Item block = null;

   public ItemScrollBlueAmplifiedPalm(ElementsInfTsukAddon instance) {
      super(instance, 958);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.setTranslationKey("scroll_blue_amplified_palm");
         this.setRegistryName("scroll_blue_amplified_palm");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§7Teaches: §9Blue Amplified Palm");
         tooltip.add("§8Toggleable mode: +60 melee damage,");
         tooltip.add("§8blue chakra aura around your hands.");
         tooltip.add("§8Duration: §930 seconds §8(auto-expires)");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            ...
            boolean ok = ItemLimitlessRelease.unlockJutsu((EntityPlayerMP)player, ItemLimitlessRelease.BLUE_AMPLIFIED_PALM.index);
            if (ok) {
               stack.shrink(1);
               player.sendMessage(new TextComponentString("§9§l★ Jutsu Learned! §r§9Blue Amplified Palm §ahas been unlocked!"));
