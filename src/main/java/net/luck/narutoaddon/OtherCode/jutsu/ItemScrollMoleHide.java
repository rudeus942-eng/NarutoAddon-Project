...
public class ItemScrollMoleHide extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_mole_hide")
   public static final Item block = null;

   public ItemScrollMoleHide(ElementsInfTsukAddon instance) {
      super(instance, 276);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.maxStackSize = 1;
         this.setTranslationKey("scroll_mole_hide");
         this.setRegistryName("scroll_mole_hide");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§6C-rank Earth Release Scroll");
         tooltip.add("§7Teaches: §eHiding Like a Mole Technique");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            try {
               ...
               Object result = enableMethod.invoke((Object)null, player, (ItemJutsu.Base)dotonItem, DotonPatcher.MOLE_HIDE, true);
               if (result != null) {
                  stack.shrink(1);
                  player.sendMessage(new TextComponentString("§6§l★ Jutsu Learned! §r§eHiding Like a Mole §ahas been added to your Earth Release!"));
                  ...
                  Particles.spawnParticle(world, Types.SMOKE, player.posX, player.posY + (double)1.5F, player.posZ, 20, (double)0.5F, (double)0.5F, (double)0.5F, 0.03, 0.05, 0.03, new int[]{-7842509, 20});
               } else {
                  player.sendMessage(new TextComponentString("§cYou must be a ninja to learn jutsu!"));
               }
            } catch (Exception e) {
               System.err.println("[InfTsuk] ScrollMoleHide: Failed to enable jutsu: " + e.getMessage());
               e.printStackTrace();
