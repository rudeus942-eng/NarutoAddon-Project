...
public class ItemScrollEarthSpear extends ElementsInfTsukAddon.ModElement {
   @ObjectHolder("inftsukaddon:scroll_earth_spear")
   public static final Item block = null;

   public ItemScrollEarthSpear(ElementsInfTsukAddon instance) {
      super(instance, 275);
   }
   ...
   public static class ItemCustom extends Item {
      public ItemCustom() {
         ...
         this.maxStackSize = 1;
         this.setTranslationKey("scroll_earth_spear");
         this.setRegistryName("scroll_earth_spear");
      ...
      public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
         ...
         tooltip.add("§7Teaches: §eEarth Spear");
      ...
      public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
         ...
         if (!world.isRemote && player instanceof EntityPlayerMP) {
            try {
               ...
               Object result = enableMethod.invoke((Object)null, player, (ItemJutsu.Base)dotonItem, DotonPatcher.EARTH_SPEAR, true);
               if (result != null) {
                  stack.shrink(1);
                  player.sendMessage(new TextComponentString("§6§l★ Jutsu Learned! §r§eEarth Spear §ahas been added to your Earth Release!"));
               ...
               System.err.println("[InfTsuk] ScrollEarthSpear: Failed to enable jutsu: " + e.getMessage());
               e.printStackTrace();
